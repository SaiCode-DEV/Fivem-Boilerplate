<template>
  <CenteredLayout>
    <TransparentCard blur-strength="15" card-class="pa-30">
      <v-card-title class="text-h4"> Test Page 2 </v-card-title>

      <v-card-text> Totally not a copy of the index page, nope. </v-card-text>

      <v-card-actions>
        <v-spacer />
        <v-btn prepend-icon="mdi-arrow-left" to="/" variant="elevated"> Go Back </v-btn>
